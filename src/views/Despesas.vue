...
import { kBlock, kFab } from "konsta/vue";
</script>
...
<template>
  <kBlock strong inset class="space-y-4">
    ...
    <p>
      ...
      <span>
        Quod praesentium consequatur autem veritatis, magni alias consectetur ut
        quo, voluptatum earum in repellat! Id, autem! Minus suscipit, ad
        possimus non voluptatem aliquam praesentium earum corrupti optio velit
        tenetur numquam?
      </span>
      <span>
        Illo id ipsa natus quidem dignissimos odio dolore veniam, accusamus vel
        assumenda nulla aliquam amet distinctio! Debitis deserunt, et, cum
    ...
    <kFab class="fixed left-1/2 bottom-4-safe transform -translate-x-1/2 z-20">
      <template #icon>
        <component :is="Plus" />
      </template>
    </kFab>
